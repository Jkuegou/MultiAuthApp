...
<head>
    ...
    <title>JuniorFood - Restaurants</title>
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="content-header">
            <h2>Liste des restaurants (32)</h2>
        ...
        <div class="filters">
            ...
            <div class="filter">Fermés</div>
        </div>

        <div class="restaurants-grid">
            <!-- Restaurant 1 -->
            <div class="restaurant-card">
                <div class="restaurant-image" style="background-image: url('/api/placeholder/300/160')"></div>
                <div class="restaurant-details">
                    <div class="restaurant-name">Burger Master</div>
            ...
            <div class="restaurant-card">
                <div class="restaurant-image" style="background-image: url('/api/placeholder/300/160')"></div>
                <div class="restaurant-details">
                    <div class="restaurant-name">Pizza Express</div>
                    <div class="restaurant-location">
                        <i class="fas fa-map-marker-alt"></i>
                        Lyon 69002
                    </div>
            ...
            <div class="restaurant-card">
                <div class="restaurant-image" style="background-image: url('/api/placeholder/300/160')"></div>
                <div class="restaurant-details">
                    <div class="restaurant-name">Sushi Paradise</div>
                    <div class="restaurant-location">
                        <i class="fas fa-map-marker-alt"></i>
                        Marseille 13001
                    </div>
            ...
            <div class="restaurant-card">
                <div class="restaurant-image" style="background-image: url('/api/placeholder/300/160')"></div>
                <div class="restaurant-details">
                    <div class="restaurant-name">Le Bistro Français</div>
                    <div class="restaurant-location">
                        <i class="fas fa-map-marker-alt"></i>
                        Bordeaux 33000
                    </div>
